...
// `std::time::Instant::now()` panics on wasm32 ("time not implemented") and
// poisons the wasm module, producing the "recursive use of an object" spam.
// `web_time::Instant` is monotonic on the web and re-exports std natively.
use tracing::debug;
