...
mod tests {
    ...
    fn test_default_regex_matches_schemed_urls() {
        assert_eq!(
            find_all("visit https://neoism.com here"),
            vec!["https://neoism.com"]
        );
    ...
    fn test_default_regex_matches_bare_relative_paths_with_extension() {
        ...
        assert_eq!(
            find_all("see neoism-frontend/desktop/src/hints.rs"),
            vec!["neoism-frontend/desktop/src/hints.rs"]
        );
    }
    ...
    fn test_default_regex_matches_dot_prefixed_paths() {
        ...
        assert_eq!(
            find_all(".config/neoism/config.toml"),
            vec![".config/neoism/config.toml"]
        );
    }
