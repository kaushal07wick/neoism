    ...
    fn tabbed_root_only_active_child_is_visible() {
        ...
        let leaf_b =
            SessionTreeLeaf::from_spec(SessionTreeLeafId(99), editor_with_route(2));
    ...
    fn move_tab_reorders_children_and_keeps_active_pointer_on_moved_tab() {
        ...
        let leaf_b =
            SessionTreeLeaf::from_spec(SessionTreeLeafId(50), editor_with_route(2));
        let leaf_c =
            SessionTreeLeaf::from_spec(SessionTreeLeafId(51), editor_with_route(3));
        tree.root = SessionTreeNode::Tabbed {
