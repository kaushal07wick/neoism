    ...
    fn path_completion_escapes_shell_glob_characters() {
        ...
        assert!(escaped
            .iter()
            .any(|candidate| candidate.replacement
    ...
    fn package_manager_completion_lists_package_json_scripts() {
        ...
        let candidates =
            completion_candidates("b", "npm run ", false, false, Some(&root));
    ...
    fn compose_block_chrome_inserts_chrome_and_drops_echo_row() {
        ...
        let frame = compose_block_chrome_window(
            visible_rows,
            visible_sources,
            &snapshots,
            6,
    ...
    fn compose_window_reports_text_matched_echo_rows_for_scroll_cursor() {
        ...
        let window = compose_block_chrome_window(
            visible_rows,
            visible_sources,
            &snapshots,
            12,
