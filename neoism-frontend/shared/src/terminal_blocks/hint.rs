use neoism_terminal_core::crosswords::pos::{Column, Direction, Line, Pos};
use neoism_terminal_core::crosswords::search::Match;
use neoism_terminal_core::crosswords::search::{RegexIter, RegexSearch};
...
impl<'a> HintMatches<'a> {
    ...
    #[inline]
    pub fn visible_regex_matches(term: &Crosswords, dfas: &mut RegexSearch) -> Self {
