...
impl ChromeBridge {
        ...
        pub fn editor_grid_update(&mut self, json: &str) -> Result<(), JsValue> {
            ...
            let parsed: EditorServerMessage =
            ...
            match parsed {
                ...
                EditorServerMessage::GridScroll {
                    ...
                    if let Some(mut snapshot) = current {
                        ...
                        if scroll_covers_visible_editor {
                            ...
                            self.pending_grid_scroll_animation_rows = self
                                .pending_grid_scroll_animation_rows
                                .saturating_add(rows);
                        }
                ...
                EditorServerMessage::GridUpdate {
                    ...
                    let mut snapshot = self
                        ...
                        .unwrap_or_else(|| {
                            neoism_ui::editor_snapshot::EditorGridSnapshot {
                                width,
                                height,
                                cells: vec![
                                    default_editor_grid_cell(
        ...
        pub fn nvim_send_keys(&mut self, bytes_b64: &str) -> Result<(), JsValue> {
            ...
            if let Some(cb) = &self.nvim_send {
                ...
                let _ =
                    cb.call1(&JsValue::NULL, &JsValue::from_str(&base64_encode(&bytes)));
            }
            Ok(())
        }
        ...
        pub fn activate_editor_grid_surface(
            &mut self,
