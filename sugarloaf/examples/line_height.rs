...
use neoism_window::event_loop::{ActiveEventLoop, ControlFlow, DeviceEvents};
...
fn main() {
    let width = 600.0;
    let height = 400.0;
    let window_event_loop = neoism_window::event_loop::EventLoop::new().unwrap();
...
impl ApplicationHandler for Application {
    fn resumed(&mut self, active_event_loop: &ActiveEventLoop) {
        ...
        sugarloaf.set_background_color(Some(sugarloaf::Color::BLUE));
