...
#[cfg(target_arch = "wasm32")]
use neoism_window::platform::web::WindowBuilderExtWebSys;
...
async fn run() {
    ...
    #[cfg(target_arch = "wasm32")]
    let window = neoism_window::window::WindowBuilder::new()
        .with_title("sugarloaf-wasm")
        .with_inner_size(neoism_window::dpi::LogicalSize::new(width, height))
    ...
    let window = neoism_window::window::Window::new(&event_loop).unwrap();
