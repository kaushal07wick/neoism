...
// (36 bytes, 8 packed attributes). Vulkan attribute formats are
...
//   loc 7  R32_SINT         pixel_offset_y (offset 32)
//
...
layout(location = 7) in int   in_pixel_offset_y;
...
void main() {
    ...
    float glyph_pixel_offset_y = float(in_pixel_offset_y);
    vec4 clip_rect = uniforms.clip_rect;
